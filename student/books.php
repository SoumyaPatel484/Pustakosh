...
<body>
  ...
  <div style=" width: 100%; height: 50px; margin-top: -20px; ">
    <div style="padding: 10px; width: 10%; height: 50px;float: left;">
    <h3 style="font-family: 'Brush Script MT', cursive;font-size: 35px; color: white; margin-top: -8px;">
  Trending:
</h3>
      
    </div>
    <div style="width: 90%; height: 50px; float: left; padding: 10px; font-size: 20px;">
      <table>
        <?php 
         while($b2=mysqli_fetch_assoc($b))
      {
        echo "<tr style='color: white; width: 400px; margin-top: 0px; float: left;'>";
...
<div class="srch" style="display: flex; flex-direction: column; align-items: flex-end;">
    ...
    <!-- Search Bar -->
    <form class="navbar-form" method="post" name="form1" id="searchForm" style="display: flex; justify-content: flex-end; align-items: center;">
        <input class="form-control" type="text" name="search" placeholder="search books.." required="" style="margin-right: 5px;">
  ...
  <!--________________request book___________________________-->

  <div class="srch">
    <form class="navbar-form" method="post" name="form1" style="display: flex; justify-content: flex-end; align-items: center;">
      
        <input class="form-control" type="text" name="bid" placeholder="Enter Book ID" required="" style="margin-right: 5px;">
  ...
  <div class="box1">
  <h2 style="font-size:35px;font-family: 'Brush Script MT', cursive;">List Of Books</h2>
  <?php
