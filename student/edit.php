...
<body>
    ...
    <div class="container">
        <h2 style="font-size:35px;font-family: 'Brush Script MT', cursive;">Edit Information</h2>
        <?php
    ...
    <div class="form-group">
        <label>Roll No:</label>
        <input class="form-control" type="text" name="roll" id="roll" value="<?php echo $roll; ?>" required 
            pattern="[0-9]{2,}" title="Roll No should be in numbers and at least 2 digits">
    </div>
    <div class="form-group">
        <label>Email:</label>
    ...
    return true;
        ...
        <?php 
            if(isset($_POST['submit'])) {
                ...
                $sql1 = "UPDATE student SET pic='images/sprofile.png', first='$first', last='$last', username='$username', password='$password', email='$email', contact='$contact' WHERE username='".$_SESSION['login_user']."';";

                if(mysqli_query($db, $sql1)) {
                    echo "<script type='text/javascript'>alert('Saved Successfully.'); window.location='profile.php';</script>";
                }
            }
        ?>
    </div>
